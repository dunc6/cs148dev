...
<html lang="en">
    <head>
        <title>Ski and Board Swap!</title>
        
        <meta charset="utf-8">
        <meta name="author" content="Collin Turner">
        <meta name="description" content="SkiSwap Database">
        ...
        // i skip it.
        $spaceAllowedPages = array("register.php");
        if (!empty($_GET)) {
        ...
        $dbUserName = 'cdturner_reader';
        $whichPass = "r"; //flag for which one to use.
        $dbName = DATABASE_NAME;
        $thisDatabaseReader = new Database($dbUserName, $whichPass, $dbName);
        
        $dbUserName = 'cdturner_writer';
        $whichPass = "w";
        $thisDatabaseWriter = new Database($dbUserName, $whichPass, $dbName);
        
        $dbUserName = 'cdturner_admin';
        $whichPass = "a";
