<?php
    ...
    $file = fopen("sql/boardboots.sql","r") or die("Error");
    
    //now print out each record
    $query = fread($file, filesize("sql/boardboots.sql"));
    $info2 = $thisDatabaseReader->select($query, "", 0, 0, 2, 0, false, false);
    $span = count($info2);
    
    print "<table class = 'boardboots'>";
    print "<caption>Snowboard Boots</caption>";
