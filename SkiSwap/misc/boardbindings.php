<?php
    ...
    $file = fopen("sql/boardbindings.sql","r") or die("Error");
    
    //now print out each record
    $query = fread($file, filesize("sql/boardbindings.sql"));
    $info2 = $thisDatabaseReader->select($query, "", 0, 0, 2, 0, false, false);
    $span = count($info2);
    
    print "<table class = 'boardbinding'>";
    print "<caption>Snowboard Bindings</caption>";
